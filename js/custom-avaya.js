...
$(document).ready(function() {
  ...
  $("#iniciarllamada").click(function() {
    ...
    console.log("Se Presiona boton de llamada");
    //Obtenemos Variables de los TextBox
    var nombre = $('#nombre_txt').val();
    var pass = $('#pass_txt').val();
    var uuid = $('#uuid_txt').val();
    //Parche para remplazar los espacios por underscores para evitar que los datos se pasen incompletos
